...
[SYMB] = LAYOUT_dactyl(
       ...
       // right hand
                ...
                KC_AMPR,     KC_1,    KC_2,  KC_3, CTL_T(KC_BSLS),  KC_TRNS,
                KC_MINS,  KC_DOT,  KC_0,  ALT_T(KC_EQL),  KC_TRNS,
      KC_TRNS,  KC_TRNS,
      KC_MINS,
      KC_UNDS,  KC_TRNS,  KC_SPC
),
...
/* Keymap 3: Tehnoklistir, dynamic macros actually
 *
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |Versn |  F1  |  F2  |  F3  |  F4  |  F5  |                    |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[TKTK] = LAYOUT_dactyl(
       ...
       KC_TRNS,  KC_EXLM,    KC_AT,  KC_LCBR,  KC_RCBR,  KC_PIPE,
       KC_TRNS,  KC_HASH,   KC_DLR,  KC_LPRN,  KC_RPRN,   KC_GRV,
          KC_TRNS, CTL_T(KC_PERC),  KC_CIRC,  KC_LBRC,  KC_RBRC,  KC_TILD,
         RESET,  R_ARR,     R_BARR,  KC_LT,  KC_GT,
                                                   DYN_REC_STOP, KC_TRNS,
                                                                 KC_EQL,
                              DYN_MACRO_PLAY1,  DYN_REC_START1,  KC_PLUS,
       // right hand
                KC_F6,      KC_F7,   KC_F8, KC_F9,  KC_F10,   KC_F11,
                KC_UP,       KC_7,    KC_8,  KC_9, KC_ASTR,   KC_F12,
                KC_DOWN,     KC_4,    KC_5,  KC_6, KC_PLUS,  KC_TRNS,
          ...
          KC_UNDS,  KC_MINS, DYN_REC_START2, DYN_MACRO_PLAY2
),
};
